        ...
        */}
        ...
        <style>{`
          ...
          */
          ...
          /* Outer and Inner glows can be added here */
        `}</style>

        <button
          ref={ref}
          className={cn("btn-liquid", glassButtonVariants({ size }), className)}
          {...props}
        >
          <div className="btn-liquid-lens absolute inset-0 -z-10 rounded-full" />
