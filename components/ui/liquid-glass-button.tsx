      ...
      <>
        ...
        <style>{`
          ...
          .btn-liquid-lens-${filterId} {
            background-color: ${glassColor || "rgba(255, 255, 255, 0.05)"};
        ...
        <Comp
          ref={ref}
          className={cn(`btn-liquid-${filterId}`, liquidButtonVariants({ size }), className)}
          {...props}
        >
          <div className={`btn-liquid-lens-${filterId} absolute inset-0 -z-10 rounded-full`} />
          <span className={cn("relative z-10 flex items-center gap-2 text-inherit", contentClassName)}>
            {children}
          </span>
        </Comp>
      </>
