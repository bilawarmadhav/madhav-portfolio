...
const socialLinks = [
  { label: 'GitHub',    href: 'https://github.com/bilawarmadhav',                     Icon: IconGithub },
  { label: 'LinkedIn',  href: 'https://www.linkedin.com/in/madhav-bilawar-a2217a340', Icon: IconLinkedin },
  { label: 'Instagram', href: 'https://www.instagram.com/madhav.dx_',                 Icon: IconInstagram },
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex flex-col lg:grid w-full max-w-6xl items-center gap-10 sm:gap-12 lg:grid-cols-2 lg:gap-20">
        ...
        >
          ...
          {/* Badge */}
          <motion.div
            className="mb-5 inline-flex items-center rounded-full border px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.2em] sm:tracking-[0.28em]"
            style={{
              color: '#e2e8f0',
